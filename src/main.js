...
import { GLTFLoader, OrbitControls, RGBELoader, EffectComposer, OutputPass, SSRPass, SSAARenderPass, GTAOPass } from 'three/examples/jsm/Addons.js';
...
loader.load("/pump/scene.gltf", (data) => {
  data.scene.position.set(0,-10,-15);
  data.scene.scale.set(0.1,0.1,0.1);
...
const light = new THREE.DirectionalLight( 0xffffff, 1.318 );
